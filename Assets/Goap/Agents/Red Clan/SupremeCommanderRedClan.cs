...
[AddComponentMenu("Commanders/SupremeCommanderRedClan")]

public class SupremeCommanderRedClan: MonoBehaviour
{
	public float globalEnergy;
	string clan;
	UnitCommanderRedClan unitCommander;
	BuildingCommanderRedClan buildingCommander;
	...
	void Start()
	{
		...
		unitCommander = (UnitCommanderRedClan)Instantiate(Resources.Load(("Prefabs/UnitCommanderRedClan"), typeof(UnitCommanderRedClan)));
		...
		buildingCommander = (BuildingCommanderRedClan)Instantiate(Resources.Load(("Prefabs/BuildingCommanderRedClan"), typeof(BuildingCommanderRedClan)));
