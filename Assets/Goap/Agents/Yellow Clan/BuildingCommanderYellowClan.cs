...
[AddComponentMenu("Commanders/BuildingCommanderYellowClan")]

public class BuildingCommanderYellowClan: MonoBehaviour
{
	...
	public void ImmigratingAgentArriving(Agent immigrant) //New immigrants arriving, add layer and upgrade excisting house
	{
